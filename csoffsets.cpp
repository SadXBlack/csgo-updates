...
signatures
{
        ...
        dwEntityList = 0x4D4E21C;
        dwForceAttack = 0x317F750;
        dwForceAttack2 = 0x317F75C;
        dwForceBackward = 0x317F798;
        dwForceForward = 0x317F7A4;
        dwForceJump = 0x51F7EB4;
        dwForceLeft = 0x317F7BC;
        dwForceRight = 0x317F7B0;
        dwGameDir = 0x6296F8;
        dwGameRulesProxy = 0x526B1AC;
        dwGetAllClasses = 0xD6003C;
        dwGlobalVars = 0x58AAD8;
        dwGlowObjectManager = 0x5296060;
        dwInput = 0x519F7C8;
        dwInterfaceLinkList = 0x904084;
        dwLocalPlayer = 0xD39BEC;
        dwMouseEnable = 0xD3F790;
        dwMouseEnablePtr = 0xD3F760;
        dwPlayerResource = 0x317DB00;
        dwRadarBase = 0x5182F8C;
        dwSensitivity = 0xD3F62C;
        dwSensitivityPtr = 0xD3F600;
        dwSetClanTag = 0x89FB0;
        dwViewMatrix = 0x4D3FB64;
        dwWeaponTable = 0x51A0288;
        dwWeaponTableIndex = 0x325C;
        dwYawPtr = 0xD3F3F0;
        dwZoomSensitivityRatioPtr = 0xD44638;
        dwbSendPackets = 0xD415A;
        dwppDirect3DDevice9 = 0xA7030;
        find_hud_element = 0x291D1B30;
        force_update_spectator_glow = 0x3A06E2;
        interface_engine_cvar = 0x3E9EC;
        is_c4_owner = 0x3AD190;
        m_bDormant = 0xED;
        m_flSpawnTime = 0xA370;
        m_pStudioHdr = 0x294C;
        m_pitchClassPtr = 0x5183228;
        m_yawClassPtr = 0xD3F3F0;
        model_ambient_min = 0x58DE4C;
        set_abs_angles = 0x1D49B0;
        set_abs_origin = 0x1D47F0;
}
